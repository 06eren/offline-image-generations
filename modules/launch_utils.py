...
def prepare_environment():
    ...
    stable_diffusion_commit_hash = os.environ.get('STABLE_DIFFUSION_COMMIT_HASH', "cf1d67a6fd5ea1aa600c4df58e5b47da45f6bdbf") or None
    stable_diffusion_xl_commit_hash = os.environ.get('STABLE_DIFFUSION_XL_COMMIT_HASH', "45c443b316737a4ab6e40413d7794a7f5657c19f") or None
    ...
    git_clone("https://github.com/nlile/stablediffusion.git", repo_dir('stable-diffusion-stability-ai'), "Stable Diffusion", None)
    try:
        git_clone(stable_diffusion_xl_repo, repo_dir('generative-models'), "Stable Diffusion XL", stable_diffusion_xl_commit_hash)
    except Exception as e:
        print(f"\nWarning: Could not clone Stable Diffusion XL repository: {e}")
        print("SDXL features may be limited.\n")
